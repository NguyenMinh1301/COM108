...
//Hàm tìm kiếm sinh viên theo mã số sinh viên (Mssv)
void TimSinhVien(struct SinhVien MangSV[], int n) {
    int i;
    char Mssv[50];

    printf("\n\t\t=============================================================================\n");
    printf("\t\t\tEnter the student ID you are looking for: ");
    ...
    for (i = 0; i < n; i++) {
        if (strcmp(MangSV[i].Mssv, Mssv) == 0) {
            printf("\n\t\t=============================================================================\n");
            printf("\t\t\tInformation students found:\n");
            printf("\t\t=============================================================================\n");
            printf("\t\tID: %s\n", MangSV[i].Mssv);
            printf("\t\tStudent name: %s\n", MangSV[i].TenSv);
            printf("\t\tField of study: %s\n", MangSV[i].NganhHoc);
